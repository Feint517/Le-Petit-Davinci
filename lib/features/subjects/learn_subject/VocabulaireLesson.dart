...
class VocabulaireLessonScreen extends StatefulWidget {
  const VocabulaireLessonScreen({super.key});

  @override
  State<VocabulaireLessonScreen> createState() => _VocabulaireLessonScreenState();
}

class _VocabulaireLessonScreenState extends State<VocabulaireLessonScreen> {
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Image.asset('assets/images/illustrations/sectionvoca.png')
                ), 
                // Points
                Container(
                ...
                Text("La girafe est le mammifère terrestre le plus grand du monde. On la reconnaît à son long cou, à ses pattes élancées et à son pelage orné de taches brunes sur fond crème. Dans la savane, elle se nourrit principalement de feuilles d’acacia qu’elle atteint grâce à sa grande taille.", style: textStyle),
                   SizedBox(height: 40),
