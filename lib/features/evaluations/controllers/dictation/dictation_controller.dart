...
class DicteeInteractiveController extends GetxController
  ...
  //* ================================================
  var selectedExercice = "Animals".obs;
  final List<String> exercices = ["Animals", "Colors", "Numbers", "Shapes"];
  void changeCategory(String category) {
    selectedExercice.value = category;
  ...
  DicteeQuestion get currentQuestion =>
      questions.isNotEmpty
          ...
          : DicteeQuestion.getSampleQuestions().first;
  ...
  void showFinalResults(BuildContext context) {
    ...
    final int percentage =
        (correctAnswers.value / questions.length * 100).toInt();
