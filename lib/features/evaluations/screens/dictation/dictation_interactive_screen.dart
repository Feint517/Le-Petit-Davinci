...
class DicteeInteractiveScreen extends GetView<DicteeInteractiveController> {
              ...
              child: Column(
                children: [
                  ...
                  Obx(() => AnimatedProgressBar(
                    progress: controller.currentDicteeIndex.value / 
                              (controller.dictees.isEmpty ? 1 : controller.dictees.length),
                    height: 8,
                    label: "Progression",
                    showPercentage: true,
    ...
    return SingleChildScrollView(
      ...
      child: Obx(() => Row(
        children: [
          ...
          _buildFilterChip(
            label: "Facile",
            isSelected: controller.difficultyFilter.value == DifficultySetting.facile,
            onTap: () => controller.filterByDifficulty(DifficultySetting.facile),
            color: Colors.green,
          ),
          const SizedBox(width: 8),
          ...
          _buildFilterChip(
            label: "Moyen",
            isSelected: controller.difficultyFilter.value == DifficultySetting.moyen,
            onTap: () => controller.filterByDifficulty(DifficultySetting.moyen),
          ...
          _buildFilterChip(
            label: "Difficile",
            isSelected: controller.difficultyFilter.value == DifficultySetting.difficile,
            onTap: () => controller.filterByDifficulty(DifficultySetting.difficile),
            color: Colors.red,
          ),
        ],
      )),
  ...
  Widget _buildBottomActions(BuildContext context) {
    return Obx(() => Row(
      ...
      children: [
          ...
          child: ElevatedButton.icon(
            ...
            icon: Icon(
              controller.selectedWords.isEmpty 
                  ...
                  : (controller.currentDicteeIndex.value == controller.dictees.length - 1 
        ...
        if (controller.selectedWords.isNotEmpty && !controller.isCheckingAnswer.value)
          const SizedBox(width: 12),
        ...
        content: Column(
          ...
          children: [
            _buildInfoStep(
              ...
              title: "Écoute",
              description: "Appuie sur le bouton audio pour entendre la dictée.",
            ),
            const SizedBox(height: 12),
            _buildInfoStep(
              icon: Icons.text_fields,
              title: "Compose",
              description: "Sélectionne les mots dans le bon ordre pour former la phrase.",
            ),
            const SizedBox(height: 12),
            _buildInfoStep(
              icon: Icons.check_circle,
              title: "Vérifie",
              description: "Appuie sur le bouton 'Vérifier' quand tu penses avoir terminé.",
            ),
            const SizedBox(height: 12),
            _buildInfoStep(
  ...
  void _showMascotHelp() {
    ...
    MascotHelper.showMascotDialog(
      title: "Besoin d'aide ?",
      message: "Écoute attentivement la phrase et sélectionne les mots dans le bon ordre !",
