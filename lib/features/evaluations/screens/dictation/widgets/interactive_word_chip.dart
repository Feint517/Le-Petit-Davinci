...
class _InteractiveWordChipState extends State<InteractiveWordChip>
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.isCorrect) {
      backgroundColor = const Color(0xFFD1FFBD).withValues(alpha: 0.8);
      borderColor = Colors.green;
      textColor = Colors.green.shade800;
    } else if (widget.isIncorrect) {
      backgroundColor = const Color(0xFFFFD6E0).withValues(alpha: 0.8);
      ...
      backgroundColor =
          widget.isInAnswer
              ? _getWordColor()
              : _getWordColor().withValues(alpha: 0.6);
      ...
      textColor = Colors.black.withValues(alpha: widget.isInAnswer ? 1.0 : 0.7);
    }
