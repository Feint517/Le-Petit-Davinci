...
class _InteractiveOptionItemState extends State<InteractiveOptionItem> with SingleTickerProviderStateMixin {
          ...
          child: Container(
            decoration: BoxDecoration(
              color: widget.isSelected
                  ? widget.color
                  : (_isPressed ? widget.color.withOpacity(0.7) : widget.color.withOpacity(0.3)),
            ...
            child: ClipRRect(
              ...
              child: Material(
                ...
                child: InkWell(
                  ...
                  highlightColor: widget.color.withOpacity(0.3),
                  child: Padding(
