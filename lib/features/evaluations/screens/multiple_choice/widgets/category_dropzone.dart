...
class CategoryDropzone extends StatelessWidget {
          ...
          DragTarget<String>(
            ...
            builder: (context, candidateData, rejectedData) {
              return Container(
                ...
                decoration: BoxDecoration(
                  color: metadataColor.withValues(alpha: 0.3),
                  borderRadius: const BorderRadius.only(
                  ...
                  border: Border.all(
                    color:
                        candidateData.isNotEmpty
                            ? metadataColor.withValues(alpha: 0.8)
                            : metadataColor.withValues(alpha: 0.5),
  ...
  Widget _buildCategoryItem(String item) {
    return Container(
      padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 6),
      decoration: BoxDecoration(
        color: metadataColor.withValues(alpha: 0.8),
        borderRadius: BorderRadius.circular(10),
        boxShadow: [
          BoxShadow(
            color: metadataColor.withValues(alpha: 0.4),
            blurRadius: 4,
