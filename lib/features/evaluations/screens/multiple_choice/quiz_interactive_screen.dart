...
class QuizInteractiveScreen extends GetView<QuizInteractiveController> {
                    ...
                    child: Obx(() {
                      try {
                        return InteractiveQuestionCard(
                          ...
                          showCelebration:
                              controller.shouldShowCelebration.value,
        ...
        () => Row(
          children: [
            ...
            _buildFilterChip(
              ...
              isSelected:
                  controller.difficultyFilter.value ==
                  QuizDifficultySetting.difficile,
              onTap:
                  () => controller.filterByDifficulty(
                    QuizDifficultySetting.difficile,
                  ),
    ...
    return Obx(
      () => Row(
        ...
        children: [
          ...
          if (controller.currentQuizIndex.value > 0) const SizedBox(width: 12),
            ...
            content: Column(
              ...
              children: [
                _buildInfoStep(
                  ...
                  title: "Observe",
                  description:
                      "Regarde bien l'image et lis la question attentivement.",
                ),
                ...
                _buildInfoStep(
                  ...
                  title: "Vérifie",
                  description:
                      "Appuie sur le bouton 'Vérifier' quand tu es prêt.",
                ),
                const SizedBox(height: 12),
                _buildInfoStep(
  ...
  void _showMascotHelp() {
    ...
    MascotHelper.showMascotDialog(
      title: "Besoin d'aide ?",
      message:
          "Regarde bien la question et les options ! Prends ton temps pour choisir ta réponse !",
