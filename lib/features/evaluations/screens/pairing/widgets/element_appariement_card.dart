...
class ElementAppariementCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (isCorrect) {
      ...
      backgroundColor = element.couleur?.withOpacity(0.1) ?? AppColors.purple.withOpacity(0.05);
      borderColor = element.couleur ?? AppColors.purple.withOpacity(0.3);
    }
    ...
    return Opacity(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: isGlowing || isSelected ? [
            BoxShadow(
              color: (isCorrect ? Colors.green : (isIncorrect ? Colors.red : borderColor)).withOpacity(0.3),
              blurRadius: 8,
              spreadRadius: 1,
            ),
          ] : null,
          ...
          child: Center(
            child: Column(
              ...
              children: [
                          ...
                          try {
                            return Image.asset(
                              ...
                              errorBuilder: (context, error, stackTrace) {
                                debugPrint('Erreur chargement image ${element.imagePath}: $error');
                      ...
                      child: FittedBox(
                        ...
                        child: Text(
                          ...
                          style: TextStyle(
                            ...
                            color: isCorrect 
                                ? AppColors.accent
                                : (isIncorrect ? AppColors.secondary : AppColors.textPrimary),
                          ),
                        ),
                      ),
                    ),
                ...
                if (element.couleur != null && element.imagePath == null && element.texte.isEmpty)
                  Expanded(
                    child: Center(
                      child: Container(
                        width: cardSize / 2,
