...
class AppariementInteractifScreen extends GetView<AppariementInteractifController> {
  const AppariementInteractifScreen({super.key});

  @override
  Widget build(BuildContext context) {
    // S'assurer que le contrôleur est initialisé de façon sécurisée
    AppariementCompatibility.getControllerSafely<AppariementInteractifController>(
              ...
              child: Column(
                children: [
                  ...
                  Obx(() => NavigationButtons(
                    ...
                    isFirstQuestion: controller.currentExerciceIndex.value == 0,
                    isLastQuestion: controller.currentExerciceIndex.value == 
                    ...
                    child: Column(
                      ...
                      children: leftElements.map((element) {
                        return Draggable<ElementAppariement>(
                          ...
                          child: Obx(() => ElementAppariementCard(
                            element: element,
                            isCorrect: controller.correctElements.contains(element.id),
                            isIncorrect: controller.incorrectElements.contains(element.id),
                            isGlowing: controller.elementsWithGlow.contains(element.id),
                          )),
                        );
                      }).toList(),
                    ),
                      ...
                      children: rightElements.map((element) {
                        return DragTarget<ElementAppariement>(
                          builder: (context, candidateData, rejectedData) {
                            ...
                            return Obx(() {
                              final String? droppedId = controller.dropTargetValues[element.id];
                                      ...
                                      child: Center(
                                        child: ElementAppariementCard(
                                          element: exercice.paires
                                              ...
                                              .firstWhere((e) => e.id == droppedId),
                                          isCorrect: controller.correctElements.contains(droppedId),
                                          isIncorrect: controller.incorrectElements.contains(droppedId),
                                        ),
                                      ),
                                    ),
                                ],
                      ...
                      child: Column(
                        ...
                        children: leftElements.map((element) {
                          return GestureDetector(
                            ...
                            child: ElementAppariementCard(
                              element: element,
                              isSelected: controller.selectedLeftElement.value?.id == element.id,
                              isCorrect: controller.correctElements.contains(element.id),
                              isIncorrect: controller.incorrectElements.contains(element.id),
                              isGlowing: controller.elementsWithGlow.contains(element.id),
          ...
          children: [
            ...
            Expanded(
              child: LayoutBuilder(builder: (context, constraints) {
                ...
                final itemSize = itemWidth * 0.9; // Légèrement plus petit pour avoir des marges
                ...
                return Obx(() => GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return GestureDetector(
                      ...
                      child: ElementAppariementCard(
                        element: element,
                        isSelected: controller.firstSelectedElement.value?.id == element.id ||
  ...
  void _showMascotHelp() {
    AppariementCompatibility.runSafely(() {
      final exercice = controller.currentExercice;
      String message = exercice.mascotMessage ?? "Associe les éléments qui vont ensemble!";
