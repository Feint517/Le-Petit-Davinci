...
void updateSnake() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                        ...
                        mainAxisAlignment: MainAxisAlignment.end,
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text('Snake Game',  // Changed from Tic Tac Toe to Snake Game
                                ...
                                if (snake.first == index) {
                                  ...
                                  return Center(
                                    child: Container( 
                                      ...
                                      child: FittedBox(
                                        child: Image.asset( 'assets/images/tictactoe/apple.png', 
                                        ),
                                      ),
                                    ),
                                  );
      ...
      floatingActionButton: showModeSelection
          ? SlideTransition(
                          ...
                          child: GestureDetector(
                            ...
                            child: AnimatedContainer(
                              ...
                              decoration: BoxDecoration(
                                ...
                                color: difficulty == 'easy' ? Colors.white : AppColors.purple,
                                borderRadius: BorderRadius.circular(15),
                              ),
                              child: Center(
                                child: Text(
                                  ...
                                  style: TextStyle(
                                    fontSize: 12,
                                    fontFamily: 'BricolageGrotesque',
                                    color: difficulty == 'easy' ? AppColors.purple : Colors.white,
                                  ),
                                ),
                              ),
                            ),
                        ...
                        Expanded(
                          child: GestureDetector(
                            ...
                            child: AnimatedContainer(
                              ...
                              decoration: BoxDecoration(
                                border: Border.all(color: AppColors.white, width: 2),
                                color: difficulty == 'medium' ? Colors.white : AppColors.purple,
                                borderRadius: BorderRadius.circular(15),
                              ),
                              child: Center(
                                child: Text(
                                  ...
                                  style: TextStyle(
                                    fontSize: 12,
                                    fontFamily: 'BricolageGrotesque',
                                    color: difficulty == 'medium' ? AppColors.purple : Colors.white,
                                  ),
                                ),
                              ),
                            ),
                        ...
                        Expanded(
                          child: GestureDetector(
                            ...
                            child: AnimatedContainer(
                              ...
                              decoration: BoxDecoration(
                                border: Border.all(color: AppColors.white, width: 2),
                                color: difficulty == 'hard' ? Colors.white : AppColors.purple,
                                borderRadius: BorderRadius.circular(15),
                              ),
                              child: Center(
                                child: Text(
                                  ...
                                  style: TextStyle(
                                    fontSize: 12,
                                    fontFamily: 'BricolageGrotesque',
                                    color: difficulty == 'hard' ? AppColors.purple : Colors.white,
                                  ),
                                ),
                              ),
                            ),
