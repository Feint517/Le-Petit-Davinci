...
class TicTacToeController extends GetxController with GetSingleTickerProviderStateMixin {
  //* Game assets
  final txtPlayerO = 'assets/images/tictactoe/o.png';
  final txtPlayerX = 'assets/images/tictactoe/x.png';
  final emptyBox = 'assets/images/tictactoe/box.png';
  ...
  //* Game board
  final xorOList = List.generate(16, (_) => 'assets/images/tictactoe/box.png').obs;
  ...
  void onTilePressed(int index) {
    ...
    if (!isMultiplayer.value && !isTurnO.value && !winnerO.value && !winnerX.value) {
  ...
  void makeHardAIMove() {
    ...
    if (filledBoxes.value <= 1 && boardSize.value == 3 && Random().nextDouble() < 0.2) {
      makeEasyAIMove();
      return;
    }
