...
import 'package:kids_learning_app/features/games/tic-tac-toe/dialogWinner.dart';
...
class _TicTacToeState extends State<TicTacToe> with SingleTickerProviderStateMixin {
  List XorOList = [
    'assets/images/tictactoe/box.png', 
    'assets/images/tictactoe/box.png', 
    'assets/images/tictactoe/box.png', 
    'assets/images/tictactoe/box.png', 
    'assets/images/tictactoe/box.png', 
  ...
  final txtPlayerO = 'assets/images/tictactoe/o.png';
  final txtPlayerX = 'assets/images/tictactoe/x.png';
                                ...
                                child: AnimatedContainer(  
                                  ...
                                  decoration: BoxDecoration(
                                    border: Border.all(color: AppColors.white, width: 2), 
                                        color: isMultiplayer ? AppColors.purple : Colors.white,
                                    borderRadius: BorderRadius.circular(15),
                                  ),
                                  child: Center(
                                    child: Row(mainAxisAlignment: MainAxisAlignment.center,crossAxisAlignment: CrossAxisAlignment.center,
                                      children: [
                                     isMultiplayer ?   Image.asset(
                                          'assets/images/tictactoe/off.png', 
                                          height: 20,
                                          width: 20,
                                        ) : Image.asset(
                                          'assets/images/tictactoe/on.png', 
                                          height: 20,
                                          width: 20,
                                        ),
                                        Text(
                                          ...
                                          style: TextStyle(
                                            fontSize: 12,
                                            fontFamily: 'BricolageGrotesque',
                                            color: isMultiplayer ? AppColors.white : AppColors.purple, 
                                          ),
                                        ),
                                      ],
                                    ),
  ...
  Column(
    ...
    children: [ 
          ...
          Expanded(
            child: GestureDetector(
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  border: Border.all(color: AppColors.white, width: 2),
                  color: aiDifficulty == 'easy' ? Colors.white : AppColors.purple,
                  borderRadius: BorderRadius.circular(15),
                ),
                child: Center(
                  child: Text(
                    ...
                    style: TextStyle(
                      fontSize: 12,
                      fontFamily: 'BricolageGrotesque',
                      color: aiDifficulty == 'easy' ? AppColors.purple : Colors.white,
                    ),
                  ),
                ),
              ),
          ...
          Expanded(
            child: GestureDetector(
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  border: Border.all(color: AppColors.white, width: 2),
                  color: aiDifficulty == 'medium' ? Colors.white : AppColors.purple,
                  borderRadius: BorderRadius.circular(15),
                ),
                child: Center(
                  child: Text(
                    ...
                    style: TextStyle(
                      fontSize: 12,
                      fontFamily: 'BricolageGrotesque',
                      color: aiDifficulty == 'medium' ? AppColors.purple : Colors.white,
                    ),
                  ),
                ),
              ),
          ...
          Expanded(
            child: GestureDetector(
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  border: Border.all(color: AppColors.white, width: 2),
                  color: aiDifficulty == 'hard' ? Colors.white : AppColors.purple,
                  borderRadius: BorderRadius.circular(15),
                ),
                child: Center(
                  child: Text(
                    ...
                    style: TextStyle(
                      fontSize: 12,
                      fontFamily: 'BricolageGrotesque',
                      color: aiDifficulty == 'hard' ? AppColors.purple : Colors.white,
                    ),
                  ),
                ),
              ),
      ...
      SizedBox(height: 15),
                        ...
                        Text('Bienvenue dans le jeu du Morpion ! Mettez votre logique et votre sens de l’observation à l’épreuve dans ce classique du Tic-Tac-Toe. Affrontez vos amis ou l’ordinateur pour aligner trois symboles consécutifs et remporter la partie. Placez vos X ou O au bon endroit et élaborez la stratégie gagnante !',
                        style: TextStyle(
                            fontSize: 12,
                            fontFamily: 'BricolageGrotesque',
                            color: AppColors.white, 
                            ...
                            child: Container( width: double.infinity,
                              ...
                              child: Row(mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                                  ...
                                  Icon(Icons.play_arrow_outlined, color: Colors.black, size: 18,),
                                ],
                              ),
                            ),
                          ),
...
void makeEasyAIMove() {
  ...
  for (int i = 0; i < boardSize * boardSize; i++) {
    if (XorOList[i] == 'assets/images/tictactoe/box.png') {
      emptySpots.add(i);
    }
  }
...
void makeMediumAIMove() {
  ...
  for (int spot in emptySpots) {
    ...
    XorOList[spot] = 'assets/images/tictactoe/x.png';
    
    // Check if this would lead to a win
    bool wouldWin = checkWouldWin('assets/images/tictactoe/x.png');
    
    // Undo the simulation
    XorOList[spot] = 'assets/images/tictactoe/box.png';
  ...
  for (int spot in emptySpots) {
    ...
    XorOList[spot] = 'assets/images/tictactoe/o.png';
    
    // Check if this would lead to a win for the player
    bool wouldWin = checkWouldWin('assets/images/tictactoe/o.png');
  ...
  if (boardSize == 3) {
    ...
    if (XorOList[4] == 'assets/images/tictactoe/box.png') {
      makeMove(4);
      return;
    }
    ...
    for (int corner in corners) {
      if (XorOList[corner] == 'assets/images/tictactoe/box.png') {
        makeMove(corner);
        return;
      }
    }
    ...
    if ((XorOList[0] == 'assets/images/tictactoe/o.png' && XorOList[8] == 'assets/images/tictactoe/o.png') ||
        (XorOList[2] == 'assets/images/tictactoe/o.png' && XorOList[6] == 'assets/images/tictactoe/o.png')) {
      // Choose a side
      List<int> sides = [1, 3, 5, 7];
      sides.shuffle();
      
      for (int side in sides) {
        if (XorOList[side] == 'assets/images/tictactoe/box.png') {
          makeMove(side);
          return;
        }
      }
  ...
  if (boardSize == 4) {
    ...
    for (int pos in centerSquare) {
      if (XorOList[pos] == 'assets/images/tictactoe/box.png') {
        makeMove(pos);
        return;
      }
    }
  ...
  for (int spot in emptySpots) {
    ...
    int potentialWins = countPotentialWins('assets/images/tictactoe/x.png');
  ...
  if (boardSize == 3) {
    ...
    for (int i = 0; i < 3; i++) {
      ...
      for (int j = 0; j < 3; j++) {
        if (XorOList[i*3+j] == player) {
          playerCount++;
        } else if (XorOList[i*3+j] == 'assets/images/tictactoe/box.png') {
          emptyCount++;
        }
      }
    ...
    for (int i = 0; i < 3; i++) {
      ...
      for (int j = 0; j < 3; j++) {
        if (XorOList[j*3+i] == player) {
          playerCount++;
        } else if (XorOList[j*3+i] == 'assets/images/tictactoe/box.png') {
          emptyCount++;
        }
      }
    ...
    for (int i = 0; i < 3; i++) {
      if (XorOList[i*4] == player) {
        diagPlayerCount1++;
      } else if (XorOList[i*4] == 'assets/images/tictactoe/box.png') {
        diagEmptyCount1++;
      }
    }
    ...
    for (int i = 0; i < 3; i++) {
      if (XorOList[(i+1)*2] == player) {
        diagPlayerCount2++;
      } else if (XorOList[(i+1)*2] == 'assets/images/tictactoe/box.png') {
        diagEmptyCount2++;
      }
    }
    ...
    for (int pos in [5, 6, 9, 10]) {
      if (XorOList[pos] == player) {
        centerCount++;
      } else if (XorOList[pos] == 'assets/images/tictactoe/box.png') {
        centerEmpty++;
      }
    }
...
int minimax(int depth, bool isMaximizing) {
  ...
  if (checkWouldWin('assets/images/tictactoe/x.png')) {
    return 10 - depth; // AI wins
  }
  
  if (checkWouldWin('assets/images/tictactoe/o.png')) {
...
void makeMove(int position) {
  setState(() {
    XorOList[position] = 'assets/images/tictactoe/x.png';
    playSound('x.mp3');
    ...
    if (winnerX == true) {
      ...
      showDialog(
        ...
        builder: (BuildContext context) {
          return GameOverDialog(  onPlayAgain: () { Navigator.pop(context);clearGame();
                          playSound('reset.mp3'); }, onMenu: () { showModeSelection = true; Navigator.pop(context); }, 
          );
        },
      );
    }
  ...
  Widget dropDownButton() {
    return Container(
      ...
      decoration: BoxDecoration(color: AppColors.kDarkBlue,
  ...
  Widget getTurn() {
    return Row(
      ...
      children: [
        ...
        SizedBox(  width: 5, ),
      Image.asset(
            isTurnO ? 'assets/images/tictactoe/o.png' : 'assets/images/tictactoe/black-X.png',
          height: 30,
          width: 30,
        ),
        ],
        ...
        child: GridView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            return GestureDetector(
              onTap: () {
                if (showModeSelection) return; // Don't allow moves when mode selection is shown
                ...
                setState(() {
                  ...
                  if(isTurnO) {
                    XorOList[index] = 'assets/images/tictactoe/o.png';
                    playSound('o.mp3');
                    filledBoxes = filledBoxes + 1;
                  } else{
                    XorOList[index] = 'assets/images/tictactoe/x.png';
                    playSound('x.mp3');
                    filledBoxes = filledBoxes + 1;
                  }
                  isTurnO =! isTurnO;
                  ...
                  if(winnerX == true) {
                    ...
                    showDialog(
                      context: context,
                      builder: (BuildContext context) {
                        return GameOverDialog(onPlayAgain: () {  }, onMenu: () {  }, 
                        );
                      },
                    );
                  } 
  ...
  void checkWinner() {
    if(boardSize == 3) {
      if(XorOList[0] == XorOList[1] &&
          ...
          XorOList[0] != 'assets/images/tictactoe/box.png'
      ) {
      ...
      if(XorOList[3] == XorOList[4] &&
          ...
          XorOList[3] != 'assets/images/tictactoe/box.png'
      ) {
      ...
      if(XorOList[6] == XorOList[7] &&
          ...
          XorOList[6] != 'assets/images/tictactoe/box.png'
      ) {
      ...
      if(XorOList[1] == XorOList[4] &&
          ...
          XorOList[1]!= 'assets/images/tictactoe/box.png'
      ) {
      ...
      if(XorOList[2] == XorOList[5] &&
          ...
          XorOList[2] != 'assets/images/tictactoe/box.png'
      ) {
    ...
    if(boardSize == 4) {
      ...
      if(XorOList[4] == XorOList[5] &&
          ...
          XorOList[4] != 'assets/images/tictactoe/box.png'
      ) {
      ...
      if(XorOList[8] == XorOList[9] &&
          ...
          XorOList[8] != 'assets/images/tictactoe/box.png'
      ) {
      ...
      if(XorOList[12] == XorOList[13] &&
          ...
          XorOList[12] != 'assets/images/tictactoe/box.png'
      ) {
    ...
    Future.delayed(Duration(seconds: 3), () {
      setState(() {
        for(int i = 0; i < XorOList.length; i++) {
          XorOList[i] = 'assets/images/tictactoe/box.png';
          filledBoxes = 0;
          winnerO = false;
          winnerX = false;
          isTurnO = true;
