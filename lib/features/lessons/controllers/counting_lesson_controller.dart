...
class CountingLessonController extends GetxController {
  // Observable variables
  final RxList<CountingQuestion> questions = <CountingQuestion>[].obs;
  ...
  CountingQuestion get currentQuestion => 
      questions.isNotEmpty ? questions[currentQuestionIndex.value] : CountingQuestion.getSampleQuestions().first;
  ...
  void onInit() {
    ...
    questions.assignAll(CountingQuestion.getSampleQuestions());
  }
  ...
  void checkAndContinue(BuildContext context) {
    ...
    LessonResultHelper.showResultScreen(
      ...
      customMessage: isCorrect 
          ? 'Bravo ! Tu as bien compté les éléments !' 
  ...
  void showFinalResults(BuildContext context) {
    ...
    LessonResultHelper.showResultScreen(
      ...
      customMessage: isPerfect 
          ? 'Tu as parfaitement réussi toutes les questions de comptage !'
