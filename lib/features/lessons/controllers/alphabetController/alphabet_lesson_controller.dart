...
class AlphabetLessonController extends GetxController with GetTickerProviderStateMixin {
  ...
  AlphabetLetter get currentLetter => 
      ...
      currentSection.letters[currentLetterIndex.value % currentSection.letters.length] : 
  ...
  void previousLetter() {
    if (currentLetterIndex.value > 0) {
      ...
      currentLetterIndex.value = sections[currentSectionIndex.value].letters.length - 1;
    }
  }
