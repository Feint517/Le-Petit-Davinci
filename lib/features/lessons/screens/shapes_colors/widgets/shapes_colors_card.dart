...
class _ShapesColorsCardState extends State<ShapesColorsCard> with SingleTickerProviderStateMixin {
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      TweenAnimationBuilder<double>(
                        ...
                        child: _buildQuestionTypeIndicator(widget.question.type),
                      ),
                    ...
                    child: GestureDetector(
                      ...
                      child: AnimatedContainer(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(
                            color: _isImageEnlarged
                                ? _getColorForQuestionType(widget.question.type)
                                : Colors.grey.withOpacity(0.2),
                            width: _isImageEnlarged ? 2 : 1,
                          ),
                          boxShadow: _isImageEnlarged ? [
                            BoxShadow(
                              color: _getColorForQuestionType(widget.question.type).withOpacity(0.3),
                              blurRadius: 10,
                              offset: const Offset(0, 4),
                            ),
                          ] : null,
                            ...
                            Positioned(
                              ...
                              child: Container(
                                ...
                                child: Icon(
                                  ...
                                  color: _getColorForQuestionType(widget.question.type),
                                  size: 20,
                                ),
                              ),
                            ),
                  ...
                  GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return TweenAnimationBuilder<double>(
                        ...
                        child: GestureDetector(
                          onTap: widget.isAnswerChecked ? null : () => widget.onAnswerSelected(option),
                          child: AnimatedContainer(
                            ...
                            child: Center(
                              child: Row(
                                ...
                                children: [
                                  ...
                                  else if (widget.isAnswerChecked && isSelected && !isCorrect)
                                    Icon(
                                      Icons.cancel,
                                      color: Colors.red,
                                      size: 20,
                                  ...
                                  if (isSelected || (widget.isAnswerChecked && isCorrect))
                                    const SizedBox(width: 8),
                                  Text(
                                    option,
                                    style: TextStyle(
                                      fontSize: 18,
                                      fontWeight: isSelected || (widget.isAnswerChecked && isCorrect)
                                          ? FontWeight.bold
                                          : FontWeight.w500,
                                      color: textColor,
                                    ),
