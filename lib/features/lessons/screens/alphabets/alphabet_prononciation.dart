                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Obx(() {
                          ...
                          return GestureDetector(
                            ...
                            child: Container(
                              margin: EdgeInsets.all(2), // Added margin between cards
                              padding: EdgeInsets.all(4), // Added internal padding
                            ...
                            .animate(controller: _letterAnimControllers[index])
                            .scale(
                              begin: Offset(1, 1),
                            ...
                            .scale(
                              begin: Offset(1, 1),
                              end: Offset(1.2, 1.2), // Smaller scale increase
